...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002964494785 -1002044203250').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001954153980'))  
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002789368043'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002663725291'))  
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002800587177')) 
auth_grp = environ.get('AUTH_GROUP')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002460160537') 
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://soumenkgp2005_db_user:4PQzJbiAqKK8gK3I@cluster0.hogont4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
AUTH_CHANNEL = environ.get("AUTH_CHANNEL", "-1002389404459") # add multiple channels here, separated by single space
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1002389404459') # add multiple channels here, separated by single space
...
BAD_WORDS = ["",""] #Remove Words From File_Name
